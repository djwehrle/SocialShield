...
namespace SocialShield.API.AppStart
{
    ...
    public class ApplicationUserManager : UserManager<UserIdentity>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<UserIdentity>(context.Get<SocialShieldIdentityDbContext>()));
            ...
            {
                manager.UserTokenProvider = new DataProtectorTokenProvider<UserIdentity>(dataProtectionProvider.Create("ASP.NET Identity"));
            }
            return manager;
        }
    }
